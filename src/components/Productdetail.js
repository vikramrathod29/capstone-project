...
export default function ProductDetail() { 
     ...
     const selectorwishlist= useSelector((state)=>state.wislist.wishitem)
  ...
  {
    try{
      const response= await axios.get("https://68e74d2d10e3f82fbf3e952c.mockapi.io/product/furnitureapi")
      setsingledata(response.data)
    }
    catch(error)
    {
      console.log("Data not fetch in productdetail page")
    }
